...
#define RTE_MAX_HEAPS 128
#define RTE_MAX_MEMSEG_LISTS 512
#define RTE_MAX_MEMSEG_PER_LIST 32768
#define RTE_MAX_MEM_MB_PER_LIST 131072
#define RTE_MAX_MEMSEG_PER_TYPE 131072
#define RTE_MAX_MEM_MB_PER_TYPE 262144
#define RTE_MAX_TAILQ 128
